...
export const fill = () => ({
  moduleMetadata,
  template: `
    <button ui-fill-button class="ui-m-2">default button</button>
    <button ui-fill-button color="basic" class="ui-m-2">basic button</button>
    <button ui-fill-button color="primary" class="ui-m-2">primary button</button>
    <button ui-fill-button color="warn" class="ui-m-2">warn button</button>
  `,
  props: {},
});
